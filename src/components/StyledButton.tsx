...
//     <button
//       onClick={onClick}
//       className="flex items-center gap-2 px-4 py-2 border-2 border-purple-300 rounded-full text-black hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-400"
//     >
//       {icon}
//       <span>{label}</span>
//     </button>
