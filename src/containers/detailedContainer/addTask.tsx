  ...
  return (
    <div className="bg-white p-4">
      <form onSubmit={handleSubmit}>
        {/* Top Row - Subject, Due Date, Time */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div>
            <label className="block text-sm mb-2 text-[#0D2167]">Subject</label>
            <input
              type="text"
              name="subject"
              ...
              className="w-full border border-gray-300 bg-[#F9F9F9] rounded-md px-3 py-2 pr-8 focus:outline-none"
            />
          </div>
            ...
            <div className="relative">
              ...
              <button 
                ...
                onClick={() => {
                  ...
                  dateInput.style.backgroundColor = '#E446EF80';
        ...
        <div className="flex flex-wrap justify-between items-center mt-8">
          ...
          <div className="flex gap-4">
            <button
              type="submit"
              className="px-6 py-2 bg-[#FBE8FF] text-[#8E198F] rounded-md hover:bg-[#828d1a81] text-sm font-medium"
            >
              Add
            </button>
            <button
